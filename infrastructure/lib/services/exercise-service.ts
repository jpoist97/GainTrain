...
export class ExerciseDataServiceStack extends Construct {
   constructor(
      ...
      const createExerciseLambda = new NodejsFunction(
         this,
      ...
      const listExercisesLambda = new NodejsFunction(
         this,
         'listExercisesLambda',
         {
            entry: join(
      ...
      const createExerciseIntegration = new LambdaIntegration(
         createExerciseLambda
      );
      const listExercisesIntegration = new LambdaIntegration(
         listExercisesLambda
      );
